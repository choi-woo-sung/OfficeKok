...
<div>
	...
	<div>
		...
		<form id="searchForm" action="${pageContext.request.contextPath}boardList.do" >
							...
							<c:choose>
								<c:when test="${not empty dataList }">
									<c:forEach var="post" items="${dataList }">
										<c:url value="/board/totalRead/${post.postno}" var="boardViewURL">
										</c:url>
										<tr class="odd gradeX">
						...
						$("<tr class='odd gradeX'>").append(
							...
							$("<td>").html(
									$("<a>").text(data.postsubject)
											.attr("href", "${pageContext.request.contextPath }/board/totalRead/" + data.postno)
