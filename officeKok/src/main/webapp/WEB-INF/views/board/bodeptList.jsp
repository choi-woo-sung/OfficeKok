...
<div>
	<!-- begin page-header -->
	<h1 class="page-header">${deptnm}게시판</h1>
	<!-- end page-header -->
		<hr>
	<div>
							...
							<c:choose>
								<c:when test="${not empty dataList }">
									<c:forEach var="post" items="${dataList }">
										<c:url value="/board/deptRead/${post.postno}" var="boardViewURL">
										</c:url>
										<tr class="odd gradeX">
						...
						$("<tr class='odd gradeX'>").append(
							...
							$("<td>").html(
									$("<a>").text(data.postsubject)
											.attr("href", "${pageContext.request.contextPath }/board/deptRead/" + data.postno)
