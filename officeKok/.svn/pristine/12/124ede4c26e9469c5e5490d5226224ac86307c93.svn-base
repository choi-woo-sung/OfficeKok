...
<link href="${pageContext.request.contextPath}/js/addrbook/addrbook.css" rel="stylesheet" />
...
<link href="https://translate.googleapis.com/translate_static/css/translateelement.css" />
							...
							<div class="panel panel-inverse">
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-12 col-md-3 ml-2">
											<div class="row">
												...
												</select> <small class="ml-2 mt-2 text-black-darker">전체 </small> <small
													id="addrBookNumberText" class="ml-2 mt-2 text-red"></small>
											</div>
										</div>
										<div class="col-sm-12 col-md-8">
											<div class="row pull-right">
												<div class="checkbox checkbox-css">
													<input type="checkbox" id="myRegistAddrChk" checked /> <label
														for="myRegistAddrChk"> <small class="text-center">내가
															등록한 주소록</small>
													</label>
												</div>
												<div class="row ml-2">
													<select class="form-control form-control-sm col-4 ml-2">
													</select> <input class="form-control form-control-sm col-4 ml-2"
														type="text" /> <a
														class="text-inverse fas fa-lg fa-fw m-r-10 ml-3 mt-2 fa-search"
														href="#"></a>
												</div>
											</div>
										</div>
													...
													<td class="with-checkbox mt-2" colspan="2">
														<div class="checkbox checkbox-css"
															...
															<input type="checkbox" id="allCheck" checked /> <label
																for="allCheck"> <small class="text-center">전체
																	선택</small>
															</label>
														</div>
													</td>
									...
									<div class="btn-group pull-right">
										<c:url value="/mail/regist" var="mailSendURL">
											<c:param name="what" value="" />
										</c:url>
										<a href="${mailSendURL}" class="btn btn-white">선택된 사용자에게 메일 보내기</a> 
										<a href="" class="btn btn-white ml-1">개인 주소록 그룹에 추가</a> 
										<a href="${addrBookRegistURL}" class="btn btn-white ml-1">등록</a>
									</div>
								</div>
							</div>
						</div>
