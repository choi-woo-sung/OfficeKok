...
<link href="${pageContext.request.contextPath}/template/assets/plugins/tag-it/css/jquery.tagit.css" rel="stylesheet" />
<link href="${pageContext.request.contextPath}/template/assets/plugins/bootstrap3-wysihtml5-bower/dist/bootstrap3-wysihtml5.min.css" rel="stylesheet" />
			<!-- begin vertical-box -->
						...
						<div class="wrapper">
							<div class="d-flex align-items-center justify-content-center">
								<a href="#emailNav" data-toggle="collapse" class="btn btn-inverse btn-sm mr-auto d-block d-lg-none">
									...
									<a href="#" data-writetype="write" class="btn btn-inverse btn-sm mr-2">
										메일 쓰기 
									</a> 
									<a href="#" data-writetype="my" class="btn btn-inverse btn-sm">
										내게 쓰기 
									</a>
							</div>
						</div>
...
<script src="${pageContext.request.contextPath}/template/assets/plugins/tag-it/js/tag-it.min.js"></script>
<script src="${pageContext.request.contextPath}/template/assets/plugins/bootstrap3-wysihtml5-bower/dist/bootstrap3-wysihtml5.all.min.js"></script>
<script src="${pageContext.request.contextPath}/template/assets/js/demo/email-compose.demo.js"></script>